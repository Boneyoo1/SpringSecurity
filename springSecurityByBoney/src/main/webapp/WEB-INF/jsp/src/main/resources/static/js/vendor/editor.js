			...
			$(this).data("menuBar", menuBar);
	       	...
	       	if(settings['status_bar']){
				editor.keyup(function(event){
					...
					$(editor_Content).data("statusBar").html('<div class="label" id="wordCount">'+'Words : '+wordCount+'</div>');
					$(editor_Content).data("statusBar").append('<div class="label" id="characterCount">'+'Characters : '+charCount+'</div>');
            	});
	        }	        
